        ...
        if ($request->ajax()) {
            ...
            return DataTables::of($log)
                ...
                ->editColumn('opsi', function($query){
                    ...
                    $form = '<form method="POST" class="'.$cek_2.'" action="'.$delete_query.'">'.csrf_field().'<input type="submit" class="btn btn-danger btn-sm m-1" onclick="return confirm(\'Data Akan Dihapus?\')" value="Delete"></form>';
